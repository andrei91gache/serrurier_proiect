      ...
      $.ajax({
        ...
        success: function() {
          ...
          $('#success > .alert-success')
            .append("<strong>Votre message a ete bien envoyee. </strong>");
          $('#success > .alert-success')
            .append('</div>');
          //clear all fields
        ...
        error: function() {
          ...
          $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
            .append("</button>");
          $('#success > .alert-danger').append($("<strong>").text("Desole " + firstName + ", il semble que le cette functionalite a ete desactive temporaiment. Veulleiz essayer plus tard!"));
